...
import { EditAnswerComponent } from './poll-definition/answer-edit/answer-edit.component';
import { PollVoteComponent } from './poll-vote/poll-vote.component';
import { PollComponent } from './poll.component';
import { PollResultsComponent } from './poll-results/poll-results.component';
import { ChartistModule } from 'ng-chartist';
@NgModule({
  declarations: [PollDefinitionComponent, PollComponent, AddAnswerComponent, EditAnswerComponent, PollVoteComponent, PollResultsComponent],
  imports: [
